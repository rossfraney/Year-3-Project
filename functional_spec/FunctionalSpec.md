...
Section 4 will focus on the individual “classes” of the system, the design decisions in terms of how each will interact with the other, dependencies, class association diagrams, sequence diagrams, etc. 
...
**2.3 Example Use Cases**
Outlined below are example of situations in which this system will prove a useful tool for users in a number of scenarios already listed. To best display the usefulness and functionality of the system.
